...
<body>
  <main class="form-signin w-100 m-auto text-center">
    <form class="needs-validation" action="index.php" method="POST" novalidate="">
      ...
      <h1 class="h1 mb-3 fw-normal display-3">LOGIN</h1>
      <?php
        if(isset($_SESSION['loginstatus']))
    {
      ...
      <button class="w-30 btn btn-md btn-secondary rounded-pill" type="reset"><i class="bi bi-eraser"></i><b> Clear</b></button>
        ...
        <a class="w-100 btn btn-md btn-success rounded-pill" href="adminlogin.php"><i class="bi bi-arrow-right-circle"></i><b> Login as Admin</b>
        </a>
      </div>
