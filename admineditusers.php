...
<body>
  ...
  <div class="text-center">
    <form action="adminupdateusers.php" method="POST" class="shadow p-3 mb-5 bg-light rounded mt-3">
      <h1 class="h1 mb-2 display-2"><b>EDIT USER</b></h1>
      <div class="form-floating mb-3">
        <input type="hidden" class="form-control border-success border-2 rounded-pill" name="id" value="<?php echo $row['id'] ?>"/>
      </div>     
      <div class="row g-1 mb-2">
        <div class="form-floating">
          <input type="text" class="form-control border-success border-2 rounded-pill" name="name" placeholder="Name" value="<?php echo $row['name'] ?>" />
          <label for="name">Name</label>
        </div>
        <div class="form-floating col">
          <input type="text" class="form-control border-success border-2 rounded-pill" name="username" placeholder="Username" value="<?php echo $row['username'] ?>" />
          <label for="username">Username</label>
        </div>
      </div>
      <div class="form-floating col mb-2">
        <input type="password" class="form-control border-success border-2 rounded-pill" name="password" placeholder="Password" />
