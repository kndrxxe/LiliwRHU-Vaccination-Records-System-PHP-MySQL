...
<body>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <form action="adminaddvaccineschedule.php" method="POST" class="shadow p-3 mb-5 bg-light rounded">
        <h1 class="h1 mb-2 display-3"><b>ADD SCHEDULE</b></h1>
        <div class="row g-1 mb-2">
          <div class="form-floating mb-2">
            <?php
            $option = mysqli_query($conn, "SELECT * FROM vaccine_list");
            ?>
            <select class="form-select border-success border-2 rounded-pill" name="vaccine_brand" placeholder="Vaccine Brand" required>
          ...
          <div class="form-floating">
            <input type="text" class="form-control border-success border-2 rounded-pill" name="vaccine_vials" placeholder="No. of Vials" required />
            <label for="vaccine_vials">No. of Vials</label>
          </div>
          <div class="form-floating col mt-2">
            <input type="text" class="form-control border-success border-2 rounded-pill" name="vaccine_venue" placeholder="Venue" />
            <label for="vaccine_venue">Venue</label>
          </div>
          <div class="form-floating mb-2">
            <input type="date" class="form-control border-success border-2 rounded-pill" name="vaccine_date" placeholder="Date" />
