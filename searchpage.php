...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="container">
        <h1 class="text-center mb-2 display-2">SEARCH</h1>
      </div>
      <div class="col-md-12">
        <div class="card mt-2">
          <div class="card-body">
              ...
              <div class="col-md-7">
                <form action="" method="GET">
                  <div class="input-group mb-2">
                    ...
                    <a href="viewall.php" class="btn btn-success"><i class="bi bi-list"></i> View All</a>
                  </div>
                </form>
              </div>
            </div>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  if (isset($_GET['search'])) {
                    ...
                    $query = "SELECT * FROM persons WHERE CONCAT(firstname,lastname,barangay) LIKE '%$filtervalues%' ";
