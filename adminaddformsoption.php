...
<body>
  ...
  <div class="container">
    <div class="text-center">
      ...
      <form action="adminaddoption.php" method="POST" class="shadow p-3 mb-5 bg-light rounded">
        <h1 class="h1 mb-2 display-3"><b>ADD DROPDOWN OPTION</b></h1>
        <div class="form-floating mb-2">
          <input type="text" class="form-control border-success border-2 rounded-pill" name="vaccinebrands" placeholder="Vaccine Brand" />
          <label for="vaccinebrands">Vaccine Brand</label>
        </div>
